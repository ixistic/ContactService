...
public class ContactDaoTest {
	...
	public void setUp() {
		...
		dao = new ContactDao();
		contact1 = new Contact("contact1", "Joe Contact", "joe@microsoft.com","000000");
		contact2 = new Contact("contact2", "Sally Contract", "sally@foo.com","000000");
		contact3 = new Contact("contact3", "Foo Bar", "foo@barclub.com","000000");
	}
